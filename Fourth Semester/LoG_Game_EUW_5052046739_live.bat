...
:start
@start "" "League of Legends.exe" "spectator spectator.euw1.lol.riotgames.com:80 toZUAVgennK0LQHUiY4fCfoGKR4m4BYP 5052046739 EUW1" -UseRads -GameBaseDir=.. "-Locale=%locale%"
goto exit
